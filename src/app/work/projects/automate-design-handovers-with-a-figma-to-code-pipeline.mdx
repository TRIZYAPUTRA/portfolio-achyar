...
summary: "Sistem ini merupakan aplikasi monitoring CCTV secara real-time yang mengimplementasikan protokol RTSP (Real Time Streaming Protocol) untuk menampilkan beberapa kamera dalam satu antarmuka live view pada desa leran. Sistem memungkinkan pengguna memantau kondisi dari berbagai titik kamera secara langsung melalui jaringan."
images:
